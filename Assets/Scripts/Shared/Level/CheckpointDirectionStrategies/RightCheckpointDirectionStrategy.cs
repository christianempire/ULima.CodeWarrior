...
{
    public class RightCheckpointDirectionStrategy : CheckpointDirectionStrategy
    {
        ...
        public override bool IsApplicable(CheckpointDirection direction) => direction == CheckpointDirection.Right;
    }
}

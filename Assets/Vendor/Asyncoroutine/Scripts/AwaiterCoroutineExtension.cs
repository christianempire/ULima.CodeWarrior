...
namespace Asyncoroutine
{
    public static class AwaiterCoroutineExtension
    {
        ...
        public static AwaiterCoroutine<UnityWebRequest> GetAwaiter(this UnityWebRequest unityWebRequest)
        {
            return new AwaiterCoroutine<UnityWebRequest>(unityWebRequest);
        }
